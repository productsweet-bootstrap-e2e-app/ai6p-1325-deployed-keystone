...
Create a new page template, add the four role cards with titles and descriptions, integrate navigation link, and verify layout on desktop and mobile

## Verification Plan

- R1: /roles page is linked in the main navigation
- R2: All four roles are listed
- R3: Each role has a visible one-line description
- R4: No sign-up form or external links appear
- R5: Page layout is responsive and matches site styling
