...
Locate the home page template in the codebase, identify the hero section, insert the mission copy as a headline or subtitle, and render the page to verify placement and readability

## Verification Plan

- R1: The exact mission copy appears on the live home page
- R2: The copy is rendered above-the-fold on desktop and mobile viewports
- R3: No other home page copy, layout, or styling has changed
- R4: Copy matches the specified text exactly
