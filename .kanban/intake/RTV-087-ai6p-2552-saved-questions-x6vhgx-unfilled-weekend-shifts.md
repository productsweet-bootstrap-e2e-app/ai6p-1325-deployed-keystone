---
title: AI6P-2552 saved questions X6VHGX — unfilled weekend shifts
id: RTV-087
status: intake
...
source: AI6P-2552 live-sacrificial round trip (disposable fixture)
...
As a roster coordinator I want to see which weekend shifts are still unfilled.
...
See unfilled weekend shifts before the weekend starts
...
```yaml
- id: review-01M2J240X26NB3759ME1D5VSWE
...
- id: review-01M2J240X268NXYE5R1NAJWMK2
...
- id: review-01M2J258DW0VN2KT07DWG3T38X
  question: Should the weekend view include Friday evening shifts?
  status: answered
  thread:
    - role: user
      text: Not this pilot — Saturday and Sunday only.
- id: review-01M2J258DW1TPWYAWKXM563Q5P
  question: Which roles should be shown on each shift?
  status: answered
  thread:
    - role: user
      text: Role and start time on every row.
```
